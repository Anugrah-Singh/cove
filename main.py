...
def main():
    ...
    print()
    print("  UTILITIES:")
    print("    python check_similarity.py     Compare two faces")
    ...
    print()
    print("  DIAGNOSTICS:")
    print("    python check_structure.py      Audit model files")
    print("    python debug_visuals.py        Visualize face detection")
